...
import com.concise.component.log.annotation.Log;
import com.concise.component.log.callback.AsyncLogCallback;
import com.concise.component.log.entity.OperLogDTO;
import com.concise.component.log.enums.BusinessStatus;
...
public class LogAspect {
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e, Object jsonResult) {
        try {
            ...
            // 设置请求标识
            operLog.setTraceId(MDCTraceUtils.getTraceId());
...
//            }
    ...
    public void saveLog(OperLogDTO operLogDTO) {
        if (asyncLogCallback != null) {
            asyncLogCallback.saveLog(operLogDTO);
        }
    }
