...
public final class MimetypesUtils {
    ...
    private static MimetypesUtils mimetypesUtils = null;
    ...
    /**
     * Gets an instance of {@link MimetypesUtils} with default mime type info. You
     ...
     * </p>
     *
     * @return an instance of {@link MimetypesUtils}
     */
    public static synchronized MimetypesUtils getInstance() {
        if (mimetypesUtils != null)
            return mimetypesUtils;

        mimetypesUtils = new MimetypesUtils();
        if (log.isDebugEnabled()) {
            Map<String, String> map = mimetypesUtils.extensionToMimetypeMap;
