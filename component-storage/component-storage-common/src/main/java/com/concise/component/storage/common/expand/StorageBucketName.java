 ...
 */
public abstract class StorageBucketName {
    protected StorageBucketName() {
    }

    /**
     * 存放所有子类
     */
    private static Map<String, StorageBucketName> subClassMap = new ConcurrentHashMap<>();
    ...
    public static  <T extends StorageBucketName> StorageBucketName getInstance(Class<T> tClass) {
        return subClassMap.get(tClass.getName());
    }
