...
public class EnableMybatisPlusRegister implements ImportBeanDefinitionRegistrar, ResourceLoaderAware, BeanClassLoaderAware, EnvironmentAware {
    ...
    public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
        try {
            ...
            // 扫描注解
            scanner.addIncludeFilter(new AnnotationTypeFilter(EnableMybatisPlus.class));

            BeanRegistrationUtil.registerBeanDefinitionIfNotExists(registry, StringUtils.uncapitalize(EnableMybatisPlusBeanDefinitionRegistryPostProcessor.class.getSimpleName()),
                    EnableMybatisPlusBeanDefinitionRegistryPostProcessor.class);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
