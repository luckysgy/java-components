...
public class ComponentDataSourceMybatisPlusMainConfig {
    private static final Logger log = LoggerFactory.getLogger(ComponentDataSourceMybatisPlusMainConfig.class);
    @PostConstruct
    public void init() {
